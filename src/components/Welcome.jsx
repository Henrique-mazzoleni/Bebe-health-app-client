    ...
    <main>
        ...
        {/* Changes card */}
            ...
            <div className='text'>
                ...
                <p>Track your childs changes by date and time, wet, dry or both, and the consistency to better understand your childs health. </p>
            </div>
            </div>
        ...
        {/* Sleeps card */}
            ...
            <div className='text'>
                ...
                <p>Record when you child sleeps, for how long and where they sleep.</p>
            </div>
            </div>
        ...
        {/* Feeds card */}
            ...
            <div className='text'>
                ...
                <p>Keep tabs on your childs milk intact, ensuring your little one is getting enough.</p>
            </div>
            </div>
        ...
        {/* Users card */}
            ...
            <div className='text'>
                ...
                <p>You can invite more guardians onto the app, making it easier to tracks your childs health.</p>
            </div>
            </div>
        ...
        {/* Children card */}
            ...
            <div className='text'>
                ...
                <p>Add as many children as you wish, allowing you to track the health of your whole family.</p>
            </div>
            </div>
